...
bool WHIPOutput::Connect()
{
	...
	std::string simulcast = videoLayerStates.size() >= 2 ? "true" : "false";
	std::string full_endpoint_url = endpoint_url + "?simulcast=" + simulcast;
	...
	curl_easy_setopt(c, CURLOPT_URL, full_endpoint_url.c_str());
